...
export interface RenderDirective { id: string; type: 'card.show' | 'transition.fade' | 'highlight.rect'; enabled: boolean; beat_id?: string | null; start_seconds: number; end_seconds: number; text?: string | null; color: string; x: number; y: number; width: number; height: number; fade_seconds: number; }
