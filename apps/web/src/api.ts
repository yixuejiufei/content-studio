...
export interface Task { task_id: string; title: string; audience: string; platform: Platform; target_seconds: number; status: 'prepare_assets' | 'ready_for_assembly' | 'rough_cut_ready'; voiceover_asset: Asset; beats: Beat[]; rough_cut?: { edit_plan: Record<string, unknown> } | null; video_export?: VideoExport | null; }
const base = '/api/v1';
